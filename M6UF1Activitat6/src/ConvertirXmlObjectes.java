...
public class ConvertirXmlObjectes {
...
public static void main(String[] args) throws JAXBException, IOException {
		...
		Row[] arrayRows = rowAux.getRows();
		
		// Mostrem el xml
		for (int i = 0; i < arrayRows.length; i++) {
			System.out.println();
			System.out.println("id: " + arrayRows[i].getId());
			System.out.println("Nom Festiu: " + arrayRows[i].getNom());
			System.out.println("Any: " + arrayRows[i].getAny());
			System.out.println("Data: " + arrayRows[i].getData());
			System.out.println("Localitzacio: " + arrayRows[i].getLocalitzacio());
		}
	}
